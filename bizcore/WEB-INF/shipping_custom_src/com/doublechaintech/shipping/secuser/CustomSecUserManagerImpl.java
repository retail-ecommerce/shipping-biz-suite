...
import com.doublechaintech.shipping.ShippingUserContextImpl;
import com.doublechaintech.shipping.LoginForm;
import com.doublechaintech.shipping.BaseEntity;
import com.doublechaintech.shipping.CommonError;
import com.doublechaintech.shipping.DAOGroup;
import com.doublechaintech.shipping.ManagerGroup;

import com.doublechaintech.shipping.UserContextImpl;
import com.doublechaintech.shipping.userapp.UserApp;
import com.doublechaintech.shipping.ShippingUserContext;
import com.doublechaintech.shipping.userapp.*;
import com.doublechaintech.shipping.listaccess.*;
import com.doublechaintech.shipping.objectaccess.*;
import com.doublechaintech.shipping.ShippingChecker;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
    ...
    public String confirmSession(ShippingUserContext userContext){
    ...
    public Object resetPassword(ShippingUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(ShippingUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public Object selectApp(ShippingUserContext userContext,
    ...
    public SecUser manage(ShippingUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(ShippingUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }
    
    public SecUser getCachedSecUser(ShippingUserContext userContext) {
    ...
    protected Object gotoApp(ShippingUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(ShippingUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(ShippingUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(ShippingUserContext userContex, int length){
    ...
    protected String getBeanName(ShippingUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(ShippingUserContext userContext, UserApp app){
        
        return  app.getObjectId();
        
    }
    protected String getServiceType(ShippingUserContext userContext, UserApp app){
        
        return app.getObjectType();
    }
    protected String getMethodName(ShippingUserContext userContext, UserApp app){
    ...
    public Object home(ShippingUserContext userContext) {
    ...
    public Object loginWithEmail(ShippingUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"email",email, password);
    
    }
    public Object login(ShippingUserContext userContext, String email,
            String password) {
    ...
    public Object loginWithLogin(ShippingUserContext userContext, String email,
            String password) {

        return loginInternal(userContext,"login",email, password);
    
    }
    public Object loginWithMobile(ShippingUserContext userContext, String email,
            String password) {
        return loginInternal(userContext,"mobile",email, password);
    
    }
    protected SecUser loadUserWith(ShippingUserContext userContext, String type, String userId) throws Exception{
    ...
    protected Object loginInternal(ShippingUserContext userContext, String type, String userId,
            String password) {
     ...
     */
    protected Object loginTheSecUserInternal(ShippingUserContext userContext, SecUser user, String loginComments) throws Exception {
    ...
    public Object showlogin(ShippingUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(ShippingUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        ShippingUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected ShippingChecker checker;
    public ShippingChecker getChecker(){
        return checker;
    }
    
    public void setChecker(ShippingChecker checker){
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((ShippingChecker)beanFactory.getBean(getCheckerBeanName()));
    ...
    protected ShippingUserContextImpl createNewConext(String path) {

        return new ShippingUserContextImpl();
    ...
    public Object checkOtherLogin(ShippingUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(ShippingUserContext userContext, String objectType, String objectId)
	...
	public UserApp updateAppPermission(ShippingUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(ShippingUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(ShippingUserContext userContext, String secUserId, String objectType,
    ...
    public Object changeCurUserPassword(ShippingUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(ShippingUserContext userContext,String objectType,String objectId) {
		try {
			this.checkUserHasManagementAccess(userContext, objectType, objectId);
			return "OK";
		}catch(Exception e){
