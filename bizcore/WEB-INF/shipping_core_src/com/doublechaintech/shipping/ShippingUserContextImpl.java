...
import com.doublechaintech.shipping.secuser.SecUserCustomManagerImpl;
...
public class ShippingUserContextImpl extends UserContextImpl implements ShippingUserContext{
	...
	static final String RESOURCE_PATH="com.doublechaintech.shipping.ShippingResources";
	static final String CUSTOM_RESOURCE_PATH="com.doublechaintech.shipping.ShippingCustomResources";
    ...
    /*
    public static SecUser getSecUser(ShippingUserContext userContext) {
	...
	public static UserApp getSingleUserAppByObjectName(ShippingUserContext userContext, String objectName)
			throws Exception {
		SecUserCustomManagerImpl secUserManager = (SecUserCustomManagerImpl) userContext.getManagerGroup()
				.getSecUserManager();
		SecUser secUser = secUserManager.getCachedSecUser(userContext);
	...
	*/
	public static SmartList<UserApp> getUserAppByName(ShippingUserContext userContext, SecUser secUser, String objectName) {
	...
	public static UserApp getUserAppByBindedEntity(ShippingUserContext userContext, BaseEntity userAppBindedObject) {
		MultipleAccessKey key = new MultipleAccessKey();
	...
	private ShippingChecker checker;
