...
public class ShippingExceptionJsonSerializer extends  JsonSerializer<ShippingException> {
	...
	@Override
	public void serialize(ShippingException exception, JsonGenerator jgen,
	...
	protected void writeExceptionMessage(String message, ShippingException exception,
	...
	protected void writeStartObject(ShippingException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		jgen.writeStartObject();
		writeClassField(CLASS,exception,jgen,provider);
	}
	
	private static final String MESSAGE_LIST = "messageList";
	protected void writeEndObject(ShippingException exception, JsonGenerator jgen,SerializerProvider provider)throws IOException,JsonProcessingException{
		
		writeMessageList(MESSAGE_LIST,exception,jgen,provider);
		jgen.writeEndObject();
	}
	protected void writeClassField(String fieldName,ShippingException exception,
	...
	protected void writeMessageList(String fieldName,ShippingException exception,
			JsonGenerator jgen, SerializerProvider provider)
			throws IOException, JsonProcessingException {
		if(exception == null){
			return; //do nothing when base entity is null
