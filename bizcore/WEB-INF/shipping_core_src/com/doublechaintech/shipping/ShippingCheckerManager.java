...
public class ShippingCheckerManager extends BaseManagerImpl {
	/*
	
	
	public static final String  ID_OF_PLATFORM ="platform.id";
	protected void checkIdOfPlatform(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfPlatform(ShippingUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkIntroductionOfPlatform(ShippingUserContext userContext, String introduction, List<Message> messageList)
	{
	...
	protected void checkCurrentVersionOfPlatform(ShippingUserContext userContext, String currentVersion, List<Message> messageList)
	{
	...
	protected void checkVersionOfPlatform(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfProfile(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfProfile(ShippingUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkPlatformIdOfProfile(ShippingUserContext userContext, String platformId, List<Message> messageList)
	{
	...
	protected void checkVersionOfProfile(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfShippingAddress(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfShippingAddress(ShippingUserContext userContext, String name, List<Message> messageList)
	{
		
	 	checkStringLengthRange(name,5, 76,NAME_OF_SHIPPING_ADDRESS, messageList); 		
		
	}	 			
	
	public static final String  CARD_NUMBER_OF_SHIPPING_ADDRESS ="shipping_address.card_number";
	protected void checkCardNumberOfShippingAddress(ShippingUserContext userContext, String cardNumber, List<Message> messageList)
	{
		
	 	checkStringLengthRange(cardNumber,7, 56,CARD_NUMBER_OF_SHIPPING_ADDRESS, messageList); 		
		
	}	 			
	
	public static final String  ADDRESS_LINE1_OF_SHIPPING_ADDRESS ="shipping_address.address_line1";
	protected void checkAddressLine1OfShippingAddress(ShippingUserContext userContext, String addressLine1, List<Message> messageList)
	{
		
	 	checkStringLengthRange(addressLine1,6, 84,ADDRESS_LINE1_OF_SHIPPING_ADDRESS, messageList); 		
		
	}	 			
	
	public static final String  ADDRESS_LINE2_OF_SHIPPING_ADDRESS ="shipping_address.address_line2";
	protected void checkAddressLine2OfShippingAddress(ShippingUserContext userContext, String addressLine2, List<Message> messageList)
	{
		
	 	checkStringLengthRange(addressLine2,3, 36,ADDRESS_LINE2_OF_SHIPPING_ADDRESS, messageList); 		
		
	}	 			
	
	public static final String  ADDRESS_LINE3_OF_SHIPPING_ADDRESS ="shipping_address.address_line3";
	protected void checkAddressLine3OfShippingAddress(ShippingUserContext userContext, String addressLine3, List<Message> messageList)
	{
		
	 	checkStringLengthRange(addressLine3,2, 28,ADDRESS_LINE3_OF_SHIPPING_ADDRESS, messageList); 		
		
	}	 			
	
	public static final String  CITY_OF_SHIPPING_ADDRESS ="shipping_address.city";
	protected void checkCityOfShippingAddress(ShippingUserContext userContext, String city, List<Message> messageList)
	{
		
	 	checkStringLengthRange(city,5, 48,CITY_OF_SHIPPING_ADDRESS, messageList); 		
		
	}	 			
	
	public static final String  STATE_OF_SHIPPING_ADDRESS ="shipping_address.state";
	protected void checkStateOfShippingAddress(ShippingUserContext userContext, String state, List<Message> messageList)
	{
	...
	protected void checkZipCodeOfShippingAddress(ShippingUserContext userContext, String zipCode, List<Message> messageList)
	{
		
	 	checkStringLengthRange(zipCode,3, 36,ZIP_CODE_OF_SHIPPING_ADDRESS, messageList); 		
		
	}	 			
	
	public static final String  PROFILE_OF_SHIPPING_ADDRESS ="shipping_address.profile";
	protected void checkProfileIdOfShippingAddress(ShippingUserContext userContext, String profileId, List<Message> messageList)
	{
		
	 	checkIdOfShippingAddress(userContext,profileId, messageList); 		
		
	}	 			
	
	public static final String  VERSION_OF_SHIPPING_ADDRESS ="shipping_address.version";
	protected void checkVersionOfShippingAddress(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserDomain(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfUserDomain(ShippingUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserDomain(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserWhiteList(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkUserIdentityOfUserWhiteList(ShippingUserContext userContext, String userIdentity, List<Message> messageList)
	{
	...
	protected void checkUserSpecialFunctionsOfUserWhiteList(ShippingUserContext userContext, String userSpecialFunctions, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfUserWhiteList(ShippingUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserWhiteList(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUser(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLoginOfSecUser(ShippingUserContext userContext, String login, List<Message> messageList)
	{
	...
	protected void checkMobileOfSecUser(ShippingUserContext userContext, String mobile, List<Message> messageList)
	{
	...
	protected void checkEmailOfSecUser(ShippingUserContext userContext, String email, List<Message> messageList)
	{
	...
	protected void checkPwdOfSecUser(ShippingUserContext userContext, String pwd, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeOfSecUser(ShippingUserContext userContext, int verificationCode, List<Message> messageList)
	{
	...
	protected void checkVerificationCodeExpireOfSecUser(ShippingUserContext userContext, DateTime verificationCodeExpire, List<Message> messageList)
	{
	...
	protected void checkLastLoginTimeOfSecUser(ShippingUserContext userContext, DateTime lastLoginTime, List<Message> messageList)
	{
	...
	protected void checkDomainIdOfSecUser(ShippingUserContext userContext, String domainId, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUser(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfSecUserBlocking(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkWhoOfSecUserBlocking(ShippingUserContext userContext, String who, List<Message> messageList)
	{
	...
	protected void checkCommentsOfSecUserBlocking(ShippingUserContext userContext, String comments, List<Message> messageList)
	{
	...
	protected void checkVersionOfSecUserBlocking(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfUserApp(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfUserApp(ShippingUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfUserApp(ShippingUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkAppIconOfUserApp(ShippingUserContext userContext, String appIcon, List<Message> messageList)
	{
	...
	protected void checkFullAccessOfUserApp(ShippingUserContext userContext, boolean fullAccess, List<Message> messageList)
	{
	...
	protected void checkPermissionOfUserApp(ShippingUserContext userContext, String permission, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfUserApp(ShippingUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkObjectIdOfUserApp(ShippingUserContext userContext, String objectId, List<Message> messageList)
	{
	...
	protected void checkLocationOfUserApp(ShippingUserContext userContext, String location, List<Message> messageList)
	{
	...
	protected void checkVersionOfUserApp(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfListAccess(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfListAccess(ShippingUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkInternalNameOfListAccess(ShippingUserContext userContext, String internalName, List<Message> messageList)
	{
	...
	protected void checkReadPermissionOfListAccess(ShippingUserContext userContext, boolean readPermission, List<Message> messageList)
	{
	...
	protected void checkCreatePermissionOfListAccess(ShippingUserContext userContext, boolean createPermission, List<Message> messageList)
	{
	...
	protected void checkDeletePermissionOfListAccess(ShippingUserContext userContext, boolean deletePermission, List<Message> messageList)
	{
	...
	protected void checkUpdatePermissionOfListAccess(ShippingUserContext userContext, boolean updatePermission, List<Message> messageList)
	{
	...
	protected void checkExecutionPermissionOfListAccess(ShippingUserContext userContext, boolean executionPermission, List<Message> messageList)
	{
	...
	protected void checkAppIdOfListAccess(ShippingUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfListAccess(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfObjectAccess(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkNameOfObjectAccess(ShippingUserContext userContext, String name, List<Message> messageList)
	{
	...
	protected void checkObjectTypeOfObjectAccess(ShippingUserContext userContext, String objectType, List<Message> messageList)
	{
	...
	protected void checkList1OfObjectAccess(ShippingUserContext userContext, String list1, List<Message> messageList)
	{
	...
	protected void checkList2OfObjectAccess(ShippingUserContext userContext, String list2, List<Message> messageList)
	{
	...
	protected void checkList3OfObjectAccess(ShippingUserContext userContext, String list3, List<Message> messageList)
	{
	...
	protected void checkList4OfObjectAccess(ShippingUserContext userContext, String list4, List<Message> messageList)
	{
	...
	protected void checkList5OfObjectAccess(ShippingUserContext userContext, String list5, List<Message> messageList)
	{
	...
	protected void checkList6OfObjectAccess(ShippingUserContext userContext, String list6, List<Message> messageList)
	{
	...
	protected void checkList7OfObjectAccess(ShippingUserContext userContext, String list7, List<Message> messageList)
	{
	...
	protected void checkList8OfObjectAccess(ShippingUserContext userContext, String list8, List<Message> messageList)
	{
	...
	protected void checkList9OfObjectAccess(ShippingUserContext userContext, String list9, List<Message> messageList)
	{
	...
	protected void checkAppIdOfObjectAccess(ShippingUserContext userContext, String appId, List<Message> messageList)
	{
	...
	protected void checkVersionOfObjectAccess(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfLoginHistory(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkFromIpOfLoginHistory(ShippingUserContext userContext, String fromIp, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfLoginHistory(ShippingUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkSecUserIdOfLoginHistory(ShippingUserContext userContext, String secUserId, List<Message> messageList)
	{
	...
	protected void checkVersionOfLoginHistory(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfGenericForm(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfGenericForm(ShippingUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfGenericForm(ShippingUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkVersionOfGenericForm(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormMessage(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormMessage(ShippingUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormMessage(ShippingUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormMessage(ShippingUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormMessage(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormFieldMessage(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkTitleOfFormFieldMessage(ShippingUserContext userContext, String title, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormFieldMessage(ShippingUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormFieldMessage(ShippingUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormFieldMessage(ShippingUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormFieldMessage(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormField(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormField(ShippingUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormField(ShippingUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkParameterNameOfFormField(ShippingUserContext userContext, String parameterName, List<Message> messageList)
	{
	...
	protected void checkTypeOfFormField(ShippingUserContext userContext, String type, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormField(ShippingUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkPlaceholderOfFormField(ShippingUserContext userContext, String placeholder, List<Message> messageList)
	{
	...
	protected void checkDefaultValueOfFormField(ShippingUserContext userContext, String defaultValue, List<Message> messageList)
	{
	...
	protected void checkDescriptionOfFormField(ShippingUserContext userContext, String description, List<Message> messageList)
	{
	...
	protected void checkFieldGroupOfFormField(ShippingUserContext userContext, String fieldGroup, List<Message> messageList)
	{
	...
	protected void checkMinimumValueOfFormField(ShippingUserContext userContext, String minimumValue, List<Message> messageList)
	{
	...
	protected void checkMaximumValueOfFormField(ShippingUserContext userContext, String maximumValue, List<Message> messageList)
	{
	...
	protected void checkRequiredOfFormField(ShippingUserContext userContext, boolean required, List<Message> messageList)
	{
	...
	protected void checkDisabledOfFormField(ShippingUserContext userContext, boolean disabled, List<Message> messageList)
	{
	...
	protected void checkCustomRenderingOfFormField(ShippingUserContext userContext, boolean customRendering, List<Message> messageList)
	{
	...
	protected void checkCandidateValuesOfFormField(ShippingUserContext userContext, String candidateValues, List<Message> messageList)
	{
	...
	protected void checkSuggestValuesOfFormField(ShippingUserContext userContext, String suggestValues, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormField(ShippingUserContext userContext, int version, List<Message> messageList)
	{
	...
	protected void checkIdOfFormAction(ShippingUserContext userContext, String id, List<Message> messageList)
	{
	...
	protected void checkLabelOfFormAction(ShippingUserContext userContext, String label, List<Message> messageList)
	{
	...
	protected void checkLocaleKeyOfFormAction(ShippingUserContext userContext, String localeKey, List<Message> messageList)
	{
	...
	protected void checkActionKeyOfFormAction(ShippingUserContext userContext, String actionKey, List<Message> messageList)
	{
	...
	protected void checkLevelOfFormAction(ShippingUserContext userContext, String level, List<Message> messageList)
	{
	...
	protected void checkUrlOfFormAction(ShippingUserContext userContext, String url, List<Message> messageList)
	{
	...
	protected void checkFormIdOfFormAction(ShippingUserContext userContext, String formId, List<Message> messageList)
	{
	...
	protected void checkVersionOfFormAction(ShippingUserContext userContext, int version, List<Message> messageList)
	{
		...
		if (!(baseUserContext instanceof ShippingUserContext)){
			super.checkAccess(baseUserContext, methodName, parameters);
			return accessOK();
		}
		ShippingUserContext userContext = (ShippingUserContext) baseUserContext;
	...
	protected void throwExceptionIfHasErrors(ShippingUserContext userContext, List<Message> messageList, Class<? extends ShippingException> exceptionClazz) throws Exception{
		//translate messages;
	...
	*/
	...
	protected void checkDateNow(Date likeTime, int i, Object now,
			String targetFieldName, ShippingException exception) {
