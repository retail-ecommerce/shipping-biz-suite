...
public class CustomRelation extends BaseRelation{
	...
	protected void prepareRelation()
	{
		...
		//replaceGenericRelation("ShippingAddress"                       , BaseRelation.TRUST_CHAIN_ALL, "profile");
	...
	protected void prepareRelationIndex()
	{
		...
		*/
		...
		//String [] shippingAddressRelatedObjectNames = {"profile:Profile"};
		//replaceRelationIndex("ShippingAddress",shippingAddressRelatedObjectNames);
