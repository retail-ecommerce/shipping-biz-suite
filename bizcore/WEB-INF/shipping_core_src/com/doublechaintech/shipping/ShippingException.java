...
@JsonSerialize(using = ShippingExceptionJsonSerializer.class)
public class ShippingException extends Exception implements MessageContainer {
    ...
    public ShippingException(Message message) {
    	super();
        this.addErrorMessage(message);
    }
	public ShippingException(List<Message> messageList) {
        super();
