<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.secuserblocking.SecUserBlocking'%>
...
<sky:include page="com/doublechaintech/shipping/secuserblocking/SecUserBlocking$Summary.jsp" />
