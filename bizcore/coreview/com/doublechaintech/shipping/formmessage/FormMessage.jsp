<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.formmessage.FormMessage'%>
...
<sky:include page="com/doublechaintech/shipping/formmessage/FormMessage$Summary.jsp" />
