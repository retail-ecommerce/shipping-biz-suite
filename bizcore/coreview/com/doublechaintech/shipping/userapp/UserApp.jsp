<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.userapp.UserApp'%>
...
<sky:include page="com/doublechaintech/shipping/userapp/UserApp$Summary.jsp" />
...
<sky:include page="com/doublechaintech/shipping/secuser/SecUser$Info.jsp" />
		...
		<div id="listAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/shipping/listaccess/ListAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
	<c:if test='${not empty userContext.accessTokens["objectAccessList"] or ignoreListAccessControl}'>
		...
		<div id="objectAccessList" class="tab-pane fade sublist" refer-name="app">
			<sky:include page="com/doublechaintech/shipping/objectaccess/ObjectAccess$List.jsp"
					referName="app"/>
		</div>
	</c:if>
