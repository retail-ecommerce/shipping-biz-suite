<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.profile.Profile'%>
...
<div class="row">
	...
	<% Profile result = (Profile)request.getAttribute("result");  %>
			<li><a data-toggle="tab" href="#shippingAddressList" class="disabled"> ${userContext.localeMap['shipping_address']}</a></li>
...
<sky:include page="com/doublechaintech/shipping/profile/Profile$Summary.jsp" />
...
<sky:include page="com/doublechaintech/shipping/platform/Platform$Info.jsp" />
		...
		<c:if test='${not empty userContext.accessTokens["shippingAddressList"] or ignoreListAccessControl}'>
		<c:set var="shippingAddressList" value="${result.shippingAddressList}" scope="request"/>
		<c:set var="shippingAddressListName" value="shippingAddressList" scope="request"/>
		<div id="shippingAddressList" class="tab-pane fade sublist" refer-name="profile">
			<sky:include page="com/doublechaintech/shipping/shippingaddress/ShippingAddress$List.jsp"
					referName="profile"/>
		</div>
	</c:if>
