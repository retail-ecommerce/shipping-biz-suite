...
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['shipping_address.card_number']}</span>
<span >${result.cardNumber}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['shipping_address.address_line1']}</span>
<span >${result.addressLine1}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['shipping_address.address_line2']}</span>
<span >${result.addressLine2}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
<span class="summary-label">${userContext.localeMap['shipping_address.address_line3']}</span>
<span >${result.addressLine3}</span>
</div>
<div class="col-xs-12 col-md-3 summary-section">
