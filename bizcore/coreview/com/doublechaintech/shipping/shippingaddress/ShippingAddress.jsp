<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.shippingaddress.ShippingAddress'%>
...
<sky:include page="com/doublechaintech/shipping/shippingaddress/ShippingAddress$Summary.jsp" />
	...
	<div class="row">
<c:set var="profile" value="${ result.profile}" scope="request" />
<sky:include page="com/doublechaintech/shipping/profile/Profile$Info.jsp" />
