<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.platform.Platform'%>
...
<sky:include page="com/doublechaintech/shipping/platform/Platform$Summary.jsp" />
		...
		<div id="profileList" class="tab-pane fade sublist" refer-name="platform">
			<sky:include page="com/doublechaintech/shipping/profile/Profile$List.jsp"
					referName="platform"/>
		</div>
	</c:if>
