<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.userwhitelist.UserWhiteList'%>
...
<sky:include page="com/doublechaintech/shipping/userwhitelist/UserWhiteList$Summary.jsp" />
