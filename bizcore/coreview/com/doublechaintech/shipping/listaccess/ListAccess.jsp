<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.listaccess.ListAccess'%>
...
<sky:include page="com/doublechaintech/shipping/listaccess/ListAccess$Summary.jsp" />
