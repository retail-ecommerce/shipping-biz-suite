<%@ page import='java.util.*,com.doublechaintech.shipping.*,com.doublechaintech.shipping.loginhistory.LoginHistory'%>
...
<sky:include page="com/doublechaintech/shipping/loginhistory/LoginHistory$Summary.jsp" />
