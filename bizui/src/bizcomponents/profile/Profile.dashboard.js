...
class ProfileDashboard extends Component {
 ...
 state = {
  ...
  render() {
    ...
    const { id,displayName, shippingAddressListMetaInfo, shippingAddressCount } = this.props.profile
    ...
    const cardsData = {cardsName:"Profile",cardsFor: "profile",
    	cardsSource: this.props.profile,returnURL,displayName,
  		subItems: [
{name: 'shippingAddressList', displayName:'Shipping Address',type:'shippingAddress',count:shippingAddressCount,addFunction: true, role: 'shippingAddress', metaInfo: shippingAddressListMetaInfo},
