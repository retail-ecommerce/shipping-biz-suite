...
<Description term="Profile">{shippingAddress.profile==null?appLocaleName(userContext,"NotAssigned"):shippingAddress.profile.displayName}
 <Icon type="swap" onClick={()=>
  showTransferModel(targetComponent,"Profile","profile","requestCandidateProfile",
	      "transferToAnotherProfile","anotherProfileId",shippingAddress.profile?shippingAddress.profile.id:"")} 
